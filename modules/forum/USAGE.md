...
2. Selecione `forum` e instale suas estruturas quando houver essa opção.
3. Cadastre ao menos uma categoria ativa em ForumTaxonomia. Teste tópico, rascunho, edição, resposta, reação, solução aceita e fechamento. Com dois usuários, valide a notificação e o tratamento de falha parcial.
4. Crie uma instância Full com identificador único, como `forum-principal`.
