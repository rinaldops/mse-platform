...
assert.deepEqual(
  ...
  { view: "recent", sort: "recentes", pageSize: 20, categoryId: null, tagId: null, topicId: null, answerId: null, compose: false, edit: false, mine: false, search: "" }
);

assert.deepEqual(
  readForumRoute(
    "https://example.test/pagina.aspx?forumView=resolved&forumSort=menosRespostas&forumPageSize=50&forumCategory=12&forumTag=7&forumTopic=42&forumAnswer=55&forumCompose=1&forumEdit=1&forumMine=1&forumSearch=SharePoint"
  ),
  { view: "resolved", sort: "menosRespostas", pageSize: 50, categoryId: 12, tagId: 7, topicId: 42, answerId: 55, compose: true, edit: true, mine: true, search: "SharePoint" }
);
...
assert.equal(
  forumRouteUrl(
    ...
    { topicId: null, tagId: 7, answerId: 9, compose: true, edit: true, view: "unanswered", sort: "visualizacoes", pageSize: 100, mine: true, search: "ETag" }
  ),
  "/pagina.aspx?origem=menu&forumView=unanswered&forumSort=visualizacoes&forumPageSize=100&forumTag=7&forumAnswer=9&forumCompose=1&forumEdit=1&forumMine=1&forumSearch=ETag"
);
