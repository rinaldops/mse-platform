(async function loadForum() {
  ...
  try {
    ...
    const [{ createSharePointDataSourceRegistry }, { sanitizeRichText }, { createForumReadService }, { mountForum }] =
      await Promise.all([
        import(`${assetBase}/mse-platform/core/0.13.5/data-sources.js`),
        import(`${assetBase}/mse-platform/core/0.13.5/rich-text.js`),
        import(`${assetBase}/mse-platform/modules/forum/0.18.8/forum-data.js`),
        import(`${assetBase}/mse-platform/modules/forum/0.18.8/forum.js`)
      ]);
