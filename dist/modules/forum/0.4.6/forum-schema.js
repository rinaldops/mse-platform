...
const LEGACY_MIGRATION_FIELDS = [
  ...
  { internalName: "LegacyListTitle", displayName: "Legado - Lista", type: "Text", maxLength: 255 },
  { internalName: "LegacyItemId", displayName: "Legado - Item ID", type: "Number" },
  { internalName: "LegacyItemUrl", displayName: "Legado - URL", type: "Text", maxLength: 255 },
  { internalName: "LegacyMigrationId", displayName: "Migração - Chave", type: "Text", indexed: true, maxLength: 255 },
  { internalName: "LegacyCreatedAt", displayName: "Legado - Criado em", type: "DateTime" },
  { internalName: "LegacyCreatedByName", displayName: "Legado - Criado por (nome)", type: "Text", maxLength: 255 },
  { internalName: "LegacyCreatedByEmail", displayName: "Legado - Criado por (email)", type: "Text", maxLength: 255 },
  { internalName: "LegacyModifiedAt", displayName: "Legado - Modificado em", type: "DateTime" },
  { internalName: "LegacyModifiedByName", displayName: "Legado - Modificado por (nome)", type: "Text", maxLength: 255 },
  { internalName: "LegacyModifiedByEmail", displayName: "Legado - Modificado por (email)", type: "Text", maxLength: 255 },
  { internalName: "IsMigrated", displayName: "Foi migrado", type: "Boolean" },
  { internalName: "MigratedAt", displayName: "Migrado em", type: "DateTime" },
  { internalName: "MigratedBy", displayName: "Migrado por", type: "Text", maxLength: 255 }
];
